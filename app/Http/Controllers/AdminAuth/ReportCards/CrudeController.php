...
class CrudeController extends Controller
{
    ...
    public function loadPDF($student_id, $schoolyear, $term){
        ...
        return compact('student', 'schoolyear', 'term', 'next_term', 'student_user', 
                        'join_grade_activities', 'comment_all', 'psychomotor', 'effective_areas', 
                        'learnining_accademic', 'courses', 'grade_grade_activities', 'health_record', 
                        'attendance', 'attendance_code', 'attendance_present', 'attendance_absent', 
                        'attendance_late', 'grade_grade_activities_ranking', 'overall_position', 
                        'grade_grade_activities_test');
    ...
    public function Print($student_id, School_year $schoolyear, Term $term)
    {
        ...
        $pdf = PDF::loadView('admin.reportcards.print', $this->loadPDF($student_id, $schoolyear, $term));
    ...
    public function PrintAll(School_year $schoolyear, Term $term )
    {
        ...
        $pdf = PDF::loadView('admin.reportcards.printall', 
                compact('schoolyear', 'term', 'next_term', 'student_users', 'grade_grade_activities', 
                        'overall_position', 'grade_grade_activities_ranking', 'join_grade_activities','courses', 
                        'health_records', 'attendances', 
