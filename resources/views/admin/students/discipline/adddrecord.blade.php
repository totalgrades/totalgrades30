          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                      <div class="header">
                          <h4 class="title">Adding disciplinary record for {{$student->first_name}} {{$student->last_name}}
                      ...
                      <div class="content">
                        <form class="form-group" action="{{ url('/students/discipline/postdrecord', [$student->id]) }}" method="POST"  enctype="multipart/form-data">
                              {{ csrf_field() }}
                                        ...
                                        <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="date" class="form-control border-input" name="drecord_date" placeholder="eg 2017-07-25">
                                              </div>
                                          </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-12">
                                              <div class="form-group">
                                                  <label><strong>Describe what happened</strong> </label>
                                                  <div class="form-group">
