                ...
                <div class="row">
                  ...
                  <hr>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Editing Psychomotor</h4>
                                      ...
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="number" name="hand_writting" class="form-control border-input" value="{{$psychomotor->hand_writting}}" required="required">
                                              </div>
                                          </div>
                                          ...
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="number" name="vabal_fluency" class="form-control border-input" value="{{$psychomotor->vabal_fluency}}" required="required" >
                                              </div>
                                          </div>
                                      ...
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="number" name="games_sport" class="form-control border-input" value="{{$psychomotor->games_sport}}" required="required">
                                              </div>
                                          </div>
                                            ...
                                            <div class="col-md-6">
                                              <div class="form-group">
                                                  ...
                                                  <input type="number" name="handling_of_tools" class="form-control border-input" value="{{$psychomotor->handling_of_tools}}" required="required" >
                                              </div>
                                          </div>
