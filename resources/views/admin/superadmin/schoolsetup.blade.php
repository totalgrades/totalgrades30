                ...
                <li>
                    ...
                    @if(!empty($school->name))
                        <a href="{{asset('/schoolsetup/schools/editschool/'.@$school->id) }}">
                            <i id="editSchoolIcon-{{ $school->id }}" class="fa fa-pencil-square-o" style="color: red" data-toggle="tooltip" title="Edit your school information"></i>
                        </a>
                        ...
                        @else
                        <button id="addNewSchool" class="btn btn-sm btn-danger" data-toggle="tooltip" title="You can only add one school. This version does not support multiple schools." style="border-radius: 6px;">
