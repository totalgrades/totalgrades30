					...
					<div class="slider-banner-container">
						<div class="slider-banner-2 bullets-with-bg">
							<ul>
								...
								<!-- main image -->
								<img src="{{asset('assets-homepublic/images/slider-2-slide-1.jpg')}}"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								<!-- main image -->
								<img src="{{asset('assets-homepublic/images/slider-2-slide-2.jpg')}}"  alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
